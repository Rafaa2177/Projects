...
import PatientProfileForm from '../../Components/Pacient/PacientForm';
...
const UpdatePatientPage = () => {
    ...
    // Função para buscar dados do paciente pelo email
    useEffect(() => {
        if (email) {
            const fetchPacient = async () => {
                ...
                try {
                    ...
                    setPacientData(data); // Armazena os dados do paciente para edição
                } catch (error) {
