...
public class RedeDistTest {
    ...
    public void testAddHub() {
        ...
        Assertions.assertTrue(redeDist.getRedeDistribuicao().vertices().contains(new Localidades("H12", new Coordenates(40.7128, -74.0060))));
        Assertions.assertTrue(redeDist.getRedeDistribuicao().vertices().contains(new Localidades("H22", new Coordenates(34.0522, -118.2437))));
        Assertions.assertTrue(redeDist.getRedeDistribuicao().vertices().contains(new Localidades("H32", new Coordenates(41.8781, -87.6298))));
    ...
    public void testAddRoute() {
        ...
        boolean routeAdded = redeDist.addRoute(
                new Localidades("H40", new Coordenates(40.7128, -74.0060)),
                new Localidades("H89", new Coordenates(34.0522, -118.2437)),
        ...
        Assertions.assertNotNull(redeDist.getRedeDistribuicao().edge(
                new Localidades("H1", new Coordenates(40.7128, -74.0060)),
                new Localidades("H2", new Coordenates(34.0522, -118.2437))
        ));
    ...
    public void testAddDuplicateRoute() {
        ...
        Assertions.assertTrue(redeDist.addRoute(new Localidades("H35"), new Localidades("H25"), 100));
        Assertions.assertFalse(redeDist.addRoute(new Localidades("H35"), new Localidades("H25"), 150));  //Adiconar uma route duplicada
