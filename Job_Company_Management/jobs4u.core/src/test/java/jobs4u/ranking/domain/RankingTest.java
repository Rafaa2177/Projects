...
public class RankingTest {
    ...
    private final JobApplication ja = new JobApplication(cfp,cc,jo);

    @Test
    void ensureRankingHasJobApplication() {
        assertThrows(IllegalArgumentException.class, () -> new Ranking(null,0, jo));
    }

    @Test
    void ensureRankingHasRank(){
       assertThrows(IllegalArgumentException.class, () -> new Ranking(ja,null, jo));
    }

    @Test
    void ensureRankingHasJobOpening(){
        assertThrows(IllegalArgumentException.class, () -> new Ranking(ja,0, null));
    }
