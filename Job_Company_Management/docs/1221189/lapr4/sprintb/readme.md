# 1221189 - Rafaela Lopes - Sprint A - Self Assessment
...
In general, the team was very communicative, and we were able to assign tasks in a clear and timely manner. We also had evidence of group tasks such as integration and deployment activities.
But we had some minor problems, such as the discovery of dependencies only at the end of the process.
But in general, we were able to work together and make decisions as a team.
...
We were able to demonstrate the system without any execution failures during the demonstration. We used the correct version of the system and we were able to demonstrate the system outside the IDE, distributed across two or more remote virtual environments (machines or containers) (e.g. in the cloud).
...
But we had some minor problems, such as incomplete definition of acceptance criteria and some acceptance criteria reflected in tests.
Nevertheless, we were able to meet all the requirements and justify our decisions.