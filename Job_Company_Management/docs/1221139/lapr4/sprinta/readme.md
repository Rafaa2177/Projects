# 1221139 - Francisco Oliveira - Sprint A - Self Assessment
...
Everyone was very active in the project, and we all contributed to the project. We had a meeting every week to discuss the project and the tasks that each one had to do. We also had a group chat where we could ask questions and discuss the project. We also had a group repository where we could see the tasks that each one had to do and the progress of the project.
