...
public class ReqModelBachelorDriverLicenseLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"EDUCATION_LEVEL", "DRIVER_LICENSE", "BACHELOR", "LICENSE", "COLLON", 
			"WS"
		};
	}
	...
	public ReqModelBachelorDriverLicenseLexer(CharStream input) {
		super(input);
